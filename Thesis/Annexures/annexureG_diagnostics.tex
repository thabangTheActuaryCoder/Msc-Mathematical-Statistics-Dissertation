...
the training data with that of the MC sample.  These
...
\caption{Continuous variable pairs: training versus MC.}
...
\caption{Conditional distributions of categorical variable pairs: training versus MC.}
...
\caption{Three-way cross-tabulations of key categorical variables: training versus MC.}
...
\caption{t-SNE projection of training versus MC joint distributions.}
...
\caption{Marginal distributions of all 11 raw predictor variables: training versus MC.}
...
\caption{Shapley attribution invariance: training data versus MC profiles.}
