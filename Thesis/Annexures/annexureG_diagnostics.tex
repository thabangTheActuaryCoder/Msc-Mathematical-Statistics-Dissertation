...
\begin{figure}[H]
    ...
    \caption{Charges \gls{kde} across partitions.}
...
\begin{figure}[H]
    ...
    \caption{Numeric feature \gls{kde} across partitions.}
...
\caption{\Gls{shap} waterfall plot for a representative high-cost profile at $\tau_{95}$.}
