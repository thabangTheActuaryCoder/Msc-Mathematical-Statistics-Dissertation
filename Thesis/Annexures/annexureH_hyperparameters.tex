...
\begin{tabular}{llrrr}
\toprule
\textbf{Phase} & \textbf{Configuration} & \textbf{Best Epoch} & \textbf{Val \ensuremath{R^2}} & \textbf{Time (s)} \\
\midrule
...
The following figures present the validation MSE loss and validation \ensuremath{R^2}
...
\caption{Phase~1: validation MSE loss (left) and validation \ensuremath{R^2}
...
\caption{Phase~2: validation MSE loss (left) and validation \ensuremath{R^2}
...
\caption{Phase~3: validation MSE loss (left) and validation \ensuremath{R^2}
(right) by batch size.}
...
\caption{Phase~4: validation MSE loss (left) and validation \ensuremath{R^2}
(right) by optimiser.}
...
\caption{Phase~5: validation MSE loss (left) and validation \ensuremath{R^2}
...
\caption{Best validation MSE loss across Phases~1 to~5.}
