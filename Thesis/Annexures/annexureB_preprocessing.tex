...
The data audit confirmed no missing values in numeric columns, no exact duplicate rows, and that all categorical levels matched the expected domain. Missing values in \texttt{medical\_\allowbreak{}history} and \texttt{family\_medical\_\allowbreak{}history} were coded as \texttt{None} and treated as a valid reference level.
