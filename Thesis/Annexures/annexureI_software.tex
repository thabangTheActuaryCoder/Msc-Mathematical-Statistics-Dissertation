...
The Python code used for data preprocessing, model training, Monte Carlo simulation, GLM benchmarking, Shapley-value computation and diagnostic figure generation is available as supplementary material. The code is organised into separate Jupyter notebooks corresponding to each stage of the analysis:
