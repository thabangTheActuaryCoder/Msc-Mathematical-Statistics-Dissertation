...
% -------------------------------------------------------------
\subsection{\Gls{dnn} Training Convergence Across Seeds}
...
\caption{Validation loss and validation \gls{r2} curves across five random seeds.}
...
\caption{Epoch versus validation \gls{r2} across five random seeds.}
...
\caption{\gls{mc} predicted-cost distributions across five \gls{dnn} seeds.}
...
\caption{Bootstrap 95\% confidence intervals for \gls{mc} mean predicted cost across five \gls{dnn} seeds.}
...
\caption{\gls{mc} convergence rate and MCSE decay across five \gls{dnn} seeds.}
...
\caption{Global mean $|\text{SHAP}|$ values across five \gls{dnn} seeds.}
...
% -------------------------------------------------------------
\subsection{\Gls{shap} Dependence Plots}
...
\caption{\Gls{shap} dependence plot for the \texttt{smoker} variable across five \gls{dnn} seeds.}
...
\caption{\Gls{shap} dependence plots for \texttt{bmi} coloured by \texttt{coverage\_level}.}
\label{fig:shap_dependence_bmi_coverage_annex}
\end{figure}

% -------------------------------------------------------------
\subsection{\Gls{shap} Interaction Diagnostics}
...
\caption{Top 15 pairwise \gls{shap} interaction correlations.}
