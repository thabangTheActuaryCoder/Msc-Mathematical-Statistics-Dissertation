...
\caption{Monte Carlo predicted-cost distributions across five DNN seeds.}
...
\caption{Bootstrap 95\% confidence intervals for Monte Carlo mean predicted cost across five DNN seeds.}
...
\caption{Monte Carlo convergence rate and MCSE decay across five DNN seeds.}
...
\caption{Base versus residual-augmented Monte Carlo distributions with cross-seed dispersion.}
