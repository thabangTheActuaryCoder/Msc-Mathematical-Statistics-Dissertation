...
\caption{Validation loss and validation \ensuremath{R^2} curves across five random seeds.}
...
\caption{Epoch versus validation \ensuremath{R^2} across five random seeds.}
...
\caption{Bootstrap 95\% confidence intervals for MC mean predicted cost across five DNN seeds.}
...
\caption{MC convergence rate and MCSE decay across five DNN seeds.}
...
\caption{Base versus residual-augmented MC distributions with cross-seed dispersion.}
