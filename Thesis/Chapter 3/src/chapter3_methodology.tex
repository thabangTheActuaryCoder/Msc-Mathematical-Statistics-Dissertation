...
\begin{subfigure}[b]{\textwidth}
    ...
    \caption{\texttt{smoker}~$\times$~\texttt{coverage\_level} interaction effects on charges.}
...
\begin{subfigure}[b]{\textwidth}
    ...
    \caption{\texttt{smoker}~$\times$~\texttt{medical\_history} interaction effects on charges.}
...
\begin{subfigure}[b]{0.65\textwidth}
    ...
    \caption{\texttt{coverage\_level}~$\times$~\texttt{gender} interaction effects on charges.}
...
\caption{PCA projection of joint input structure: training, MC sample and overlay.}
