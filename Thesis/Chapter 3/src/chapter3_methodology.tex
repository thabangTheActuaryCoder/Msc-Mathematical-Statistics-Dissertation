...
\noindent
This chapter translates the conceptual DNN, \gls{mc} and Shapley framework
...
training protocol of the feed-forward \gls{dnn} that serves as
the prediction function; and it presents the predictive and structural
checks that must be satisfied before the network is used in the \gls{mc}
and Shapley-value analyses.  The \gls{mc} simulation design, a
...
\begin{enumerate}
    ...
    \item The weak linear correlations among the numerical predictors,
          ...
          product-marginal independence assumption in the \gls{mc}
...
\subsubsection{Benchmark \Gls{glm}}
...
% =============================================================
\subsection{Parametric \gls{mc} Simulation Design}
...
\subsubsection{Base DNN \gls{mc} scoring}
...
\end{equation}
\equationlistentry{Base \gls{mc} DNN prediction}
...
% =============================================================
\subsection{Validation of the \gls{mc} Input Distribution}
...
\gls{mc} sample draws each variable independently, the off-diagonal
...
\subsubsection{Bootstrap \gls{mc} resampling}
...
% =============================================================
\subsection{Residual-Augmented \gls{mc} Sensitivity Analysis}
...
The attribution analysis is interpreted jointly with the \gls{mc}
distribution. \gls{mc} simulation identifies the distributional regions of
