...
\begin{enumerate}
    \item \textbf{Hidden activation:}  \gls{celu}, GELU and Tanh are evaluated
...
entries of the \gls{mc} correlation matrix are approximately zero by
...
\caption{PCA projection of joint input structure: training, \gls{mc} sample and overlay.}
