...
dataset \citep{kaggleInsuranceDataML}, described in
Section~\ref{sec:data_source_variable_structure}.  The chapter proceeds sequentially:
...
matrices.  The Pearson correlation matrix is computed separately for the $q = 11$
