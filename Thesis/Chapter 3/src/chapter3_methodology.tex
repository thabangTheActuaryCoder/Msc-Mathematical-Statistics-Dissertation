...
inspected, and Kolmogorov--Smirnov and Anderson--Darling statistics are
recorded.  For discrete and categorical variables, observed and fitted
category probabilities are compared using frequency tables and chi-squared
summaries.  Because the sample size is large, formal tests are interpreted
cautiously: very small distributional differences may be statistically
significant without being practically important for simulation.  Support
