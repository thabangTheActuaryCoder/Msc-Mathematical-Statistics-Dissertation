...
of Chapter~\ref{sec:literature_review} into a concrete empirical workflow.  The analysis uses the Kaggle Insurance Data for Machine Learning benchmark dataset \citep{kaggleInsuranceDataML}, containing one
...
\begin{table}[H]
\centering
\caption{Feed-forward \gls{dnn} architecture and training configuration.}
...
the \gls{dnn}, which does not assume normality of residuals. Panel~(d) plots
...
\subsubsection{Base \gls{dnn} \gls{mc} scoring}
...
The gradient-based SHAP explainer computes
