...
\noindent
The review begins with the integrated DNN, \gls{mc} and Shapley framework
...
\subsection{DNN-\gls{mc}-Shapley Framework}
...
\label{sec:statistical_learning_supervised_regression}
  ...
  \noindent
  The predictive component of the DNN-\gls{mc}-Shapley workflow is a
