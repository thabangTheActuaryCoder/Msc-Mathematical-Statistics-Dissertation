...
background data and the \gls{shap} convention used.
...
\[
    ...
    \frac{\widetilde{\mathbf{m}}_{t}}
         {\sqrt{\widehat{\mathbf{s}}_{t}}+\epsilon}.
\]
\Gls{nadam} therefore retains Adam's adaptive second-moment scaling while modifying
