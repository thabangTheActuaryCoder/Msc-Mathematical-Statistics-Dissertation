...
to health insurance cost prediction: a fitted \gls{dnn} provides the
prediction surface, \gls{mc} simulation generates synthetic policyholder
profiles from parametric distributions fitted to the observed training
...
with particular attention given to the high-cost region of the simulated
predicted-cost distribution.  The primary
