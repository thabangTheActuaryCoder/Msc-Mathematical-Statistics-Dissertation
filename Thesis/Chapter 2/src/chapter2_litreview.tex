...
tabular-data methods. Tree-based models and ensemble methods such as random
forests and gradient-boosted trees can also capture nonlinearities and
...
continuous forward-pass evaluation over large simulated input samples.  A random
forest and an XGBoost regressor are fitted as benchmarks to contextualise the
