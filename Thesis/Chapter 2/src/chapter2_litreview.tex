...
\noindent
The review begins with the integrated DNN--Monte Carlo--Shapley framework
...
\emph{model-implied predicted-cost distribution} under \(\widehat{F}_{X}\)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{Thesis/Chapter 2/Figures/Screenshot 2026-05-17 at 00.48.56.png}
...
(Figure~\ref{fig:integrated_framework}).  The concrete data pipeline,
...
concrete data pipeline, specifying the benchmark dataset, preprocessing
